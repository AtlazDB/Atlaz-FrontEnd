    ...
    <div v-else-if="resumoDados" class="fade-in space-y-8 w-full">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-slate-100 shadow-sm rounded-3xl p-6 transition-all hover:shadow-md">
          ...
          <h3 class="text-3xl font-black text-slate-900 mt-1">
            {{ resumoDados.metrics.viaturasAtivas }}/{{ resumoDados.metrics.viaturasTotal }}
          </h3>
        </div>
        ...
        <div class="bg-white border border-slate-100 shadow-sm rounded-3xl p-6 transition-all hover:shadow-md">
          ...
          <h3 class="text-3xl font-black text-slate-900 mt-1">
            {{ resumoDados.metrics.tecnicosEmCampo }}
          </h3>
        </div>
        ...
        <div class="bg-white border border-slate-100 shadow-sm rounded-3xl p-6 transition-all hover:shadow-md">
          ...
          <h3 class="text-3xl font-black text-slate-900 mt-1">
            {{ resumoDados.metrics.consumoMedio }} <span class="text-lg font-bold">km/L</span>
          </h3>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 gap-8">
        <div class="bg-white border border-slate-100 shadow-sm rounded-3xl p-6 transition-all hover:shadow-md h-full">
          ...
          <div class="space-y-4">
            <div
              v-for="atividade in resumoDados.ativadesHoje"
              :key="atividade.id"
            ...
            <div v-if="resumoDados.ativadesHoje.length === 0" class="text-center py-4 text-slate-500 text-sm">
